...
namespace Course_work_3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            SendingRequest<AccidentType> AccidentType_sender = new SendingRequest<AccidentType>("get", "Accident_Type", new AccidentType());
            ...
            {
                Type_of_accident.Items.Add(typelist[i]);
            }
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            ...
            form.Country = Country.Text;
            form.Region = Region.Text;
            form.Settlement = Settlement.Text;
            form.Object = Object.Text;
            form.Type = Type_of_accident.Text;
            form.Budget = Budget.Text;
            form.Date_of_accident = Date.Value.Year+"-"+Date.Value.Month+"-"+Date.Value.Day+"T"+Date.Value.Hour+":"+Date.Value.Minute+":"+Date.Value.Second;
            form.ActionList = executedactionlist;
